...
//WebUI.sendKeys(findTestObject('Object Repository/UserLoginSearch/SearchInput'), GlobalVariable.LoginUserNameVIPRE)
//WebUI.sendKeys(findTestObject('Object Repository/UserLoginSearch/SearchInput'), Keys.chord(Keys.ENTER))

//Click on the people
//WebUI.scrollToElement(findTestObject('Object Repository/UserLoginSearch/PeopleElement'), 20)
