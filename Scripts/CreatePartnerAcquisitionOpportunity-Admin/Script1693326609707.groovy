...
//WebUI.callTestCase(findTestCase('Test Cases/CreatingResellerAccount-VIPRE-Admin'), null)
...
WebUI.setText(findTestObject('Object Repository/PartnerAcquisitionCreation/CloseDateBox'), GlobalVariable.CloseDate, FailureHandling.STOP_ON_FAILURE)
