...
WebUI.click(findTestObject('DirectQuoteCreationObject/QuoteSalesTerritoryValue', [('value') : GlobalVariable.SalesTerritory_ExcelMicro]))
...
WebUI.click(findTestObject('Object Repository/DirectQuoteCreationObject/BillingEntityValue',[('value') : GlobalVariable.BillingEntity_ExcelMicro]))
