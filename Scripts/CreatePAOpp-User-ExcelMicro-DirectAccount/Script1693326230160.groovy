...
WebUI.click(findTestObject('Object Repository/PartnerAcquisitionCreation/ClickonCreatedOpportunity',[('value') : GlobalVariable.AccountName_Direct_ExcelMicro]), FailureHandling.STOP_ON_FAILURE)

//WebUI.executeJavaScript('document.body.style.zoom="60%"', null)

WebUI.verifyElementPresent(findTestObject('Object Repository/PartnerAcquisitionCreation/PAOppPageVerify',[('value') : GlobalVariable.AccountName_Direct_ExcelMicro]), 20, FailureHandling.STOP_ON_FAILURE)
